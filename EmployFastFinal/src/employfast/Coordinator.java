...
/**
 * Entity Class - Coordinator
 * @author akhsi, rongkun, shonik, yuan
 */
public class Coordinator extends User {
    ...
    /**
     * displays UI for creating a mission
     */
                        ...
                        switch (in) {
                            case "1":
                                ...
                                if (!complete && !back) {
                                    ...
                                    back = check[1];
                                    if (!complete && !back) {
                                        System.out.println("You choose cargo requirements for the journey \nPlease input the available number of this cargo");
    ...
    /**
     * displays a list of mission in tabular format
 ...
 /*for (int i = 0; i < missionID.size(); i++) {
    ...
    /**
     * modify mission data
     * @param uid user id of user modifying
     * @param uname user name of user modifying
     * @param userType user type of user modifying
     * @param userpw user password of user modifying
     * @param efsys the current EmployFastSystem persistence variable
     * @param operation "choose" or "modify" operations available
     */
     ...
     * @param FileData contents to add to the target file
     */
    ...
    /**
     * Displays the attributes of given mission
     * @param mission of the mission to display
     */
    ...
    /**
     * outputs the Mission object given mission ID
     * @param missionID input mission ID 
    ...
    /**
     * Turns Mission object into write-able format and writes to text file
     * @param mission Mission object to output to file
     */
    ...
    /**
     * Stores mission into file after user modifies mission data
     * @param mission Mission to store
     * @param lineIndex Index of mission inside the mission file
     */
    ...
    /**
     * modifies file data 
     * @param filePath path of file to output to
     * @param changeData contents of the new information
     * @param lineIndex index of the file to change
     */
    ...
    /**
     * checks if String is integers only
     * @param input String data
     * @return boolean whether input is int or not
     */
    ...
    /**
     * checks existing Mission ID file for repeating mission IDs
     * @param missionID String mission ID to check 
     * @return boolean of whether exists or not
     */
