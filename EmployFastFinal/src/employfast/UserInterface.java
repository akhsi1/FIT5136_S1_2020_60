...
class UserInterface {
    ...
    /**
     * User interface display for login menu
     */
...
//            String password = String.valueOf(pwchars);
    ...
    /**
     * checks if user pressed E to exit the program
     *
     * @param input String of input
     * @return boolean whether input was E for exit or not
     */
    ...
    /**
     * accepts UI call for admin home menu given user parameters
     *
     * @param userId String user id
     * @param userName String user name
     * @param userType String user type e.g. admin or coordinator
     * @param userpw String user's password
     * @param efsys EmployFastSystem persistence value to remember
     * selectedMission and selectedShuttle
     */
    ...
    /**
     * displays administrator home UI
     */
    ...
    /**
     * Display 2 String options and waits for user input
     *
     * @param dothis String of first option
     * @param dothat String of second option
     * @return
     */
    ...
    /**
     * displays the mission list for choosing the mission or modify the mission
     *
     * @param operation "choose" or "modify"
     */
...
//    }
    /**
     * Outputs gaps to create table format of information and improve visual
     * appearance of data
     *
     * @param a int consistent length of every data row
     * @param b int length of the actual data
     */
    ...
    /**
     * displays N best candidates based on current selected mission and
     * selection criteria
     */
...
//        efs.setSelectedMission(mish);
    ...
    /**
     * display coordinator menu given the EmployFastSystem persistence value
     *
     * @param efs EmployFastSystem persistence value
     */
    ...
    /**
     * displays all information related to a single shuttle
     *
     * @param s Shuttle to display
     */
    ...
    /**
     * display all shuttles for user selection
     */
                                    ...
                                    if (sh.getShuttleId().equals(input)) {
                                        ...
                                        while (!yesno) {
                                            ...
                                            if (userinput.equals("Y")) {
                                                ...
                                                System.out.println("MISSION ID IS HERE WTF" + efs.getSelectedMission().getMissionID());
                                                displayAdminHome();
                                                return;
...
//        }
    ...
    /**
     * displays the coordinator menu UI
     */
    ...
    /**
     * clears the command prompt when called
     */
    ...
    /**
     * displays the current selection criteria in tabular format
     */
    ...
    /**
     * displays the UI to modify or create selection criteria
     */
     ...
     * @return boolean of whether it is an int or not
     */
